...
while True:
    ...
    while i < 3:
        ...
        output = llm(
            ...
            + answer
            + "' \n "
            + " What is the answer of above chat history in a word? Don't answer with long. If you are not sure about the answer of above chat history, answer 'NULL' please. A: ",
            max_tokens=64,
            # stop=["Q:", "\n"],
            echo=True,
        )
